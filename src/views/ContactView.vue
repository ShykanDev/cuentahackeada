    ...
    <template #main>
      <div class="max-w-6xl mx-auto bg-white p-4 font-[sans-serif]">
        <div
          ...
          <div>
            <h2 class="text-3xl font-bold text-gray-800">Contactenos</h2>
            <p class="mt-4 text-sm leading-relaxed text-gray-500">Necesita ayuda o asesoramiento, estámos para servirle,
              sientase libre de contactarnos por cualquiera de nuestros medios.
            </p>
            ...
            <ul class="flex flex-wrap justify-center gap-6 mt-4">
              <li class="flex items-center text-blue-600">
                ...
                <a href="mailto:informes@prasadam.mx" class="ml-3 text-sm">
                  <strong>informes@prasadam.mx</strong>
                </a>
              </li>
              <li class="flex items-center text-blue-600">
                <svg xmlns="http://www.w3.org/2000/svg" width="16px" height="16px" fill='currentColor'
                ...
                <a href="javascript:void(0)" class="ml-3 text-sm">
                  <strong>+52 55 6395 0179</strong>
                </a>
                <a href="javascript:void(0)" class="ml-3 text-sm">
                  <strong>+52 55 6395 0178</strong>
                </a>
              </li>
            </ul>
          </div>
          <div class="z-10 relative h-full max-md:min-h-[350px]">
            <iframe
              src="https://www.google.com/maps/embed?pb=!1m14!1m8!1m3!1d15050.158369675277!2d-99.17607!3d19.432289!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x85d1f8b32758939b%3A0xf34fbd07bc47d6dd!2sGutenberg%20128%2C%20Anzures%2C%20Miguel%20Hidalgo%2C%2011590%20Ciudad%20de%20M%C3%A9xico%2C%20CDMX!5e0!3m2!1sen!2smx!4v1735599174806!5m2!1sen!2smx"
              class="top-0 left-0 w-full h-full" frameborder="0" allowfullscreen></iframe>
          </div>
        </div>
      </div>
    </template>
